...
namespace HoldablePad.Scripts.Pages
{
    public class Page
    {
        ...
        public void SetSlots(bool? AudioSlot, bool? CustomColourSlot, bool? LightSlot, bool? ParticlesSlot, bool? GunSlot, bool? VibrationsSlot)
        {
            var array = new bool?[] { AudioSlot, CustomColourSlot, LightSlot, ParticlesSlot, GunSlot, VibrationsSlot };
