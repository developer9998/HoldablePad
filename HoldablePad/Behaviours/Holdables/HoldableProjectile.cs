...
{
    public class HoldableProjectile : MonoBehaviour
    {
        public Vector3 targetVelocity;
        public HoldableGun ReferenceHoldable;
        ...
        public void OnCollisionEnter(Collision collision)
        {
            ...
            {
                // Use the collision contact point as the hit position and the object's position as the launch point
